...
### Upload hook (OSIE) image to lab-kube

```bash
KUBECONFIG=kubeconfig-lab-kube-master kubectl get -n tink-system -l app=tink-stack pods
KUBECONFIG=kubeconfig-lab-kube-master kubectl cp -n tink-system initramfs-x86_64 tink-stack-558b7f87b9-xnkxg:/usr/share/nginx/html/ -c tink-stack
KUBECONFIG=kubeconfig-lab-kube-master kubectl cp -n tink-system vmlinuz-x86_64 tink-stack-558b7f87b9-xnkxg:/usr/share/nginx/html/ -c tink-stack
```
